        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="breadcrumbs-inner">
                    <h3 class="page-title">Facebook Ads</h3>
                    <p class="white">Facebook Ads é a ferramenta ideal para colocar a sua empresa na mira dos usuários certos, no local certo, sugerindo suas postagens, sua página e ofertas para a audiência exata que você procura.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="services-left-sidebar">
                    <div class="serives-content-one">
                        <div class="banner-top">
                            <img src="<?=base_url('assets/'.THEME)?>/images/servicos/face.png" alt="Facebook ADS">
                        </div>
                        <div class="single-services-details1">
                            <h3>O que é?</h3>
                            <p>O Facebook Ads é o sistema de mídia paga do Facebook que oferece uma grande variedade de formatos de anúncios. É extremamente eficaz graças às diversas opções de segmentação disponíveis para os anunciantes o que gera maior número de conversões.</p>
                            <p> O Facebook Ads é hoje uma das mídias pagas mais eficientes para o Marketing Digital. Os seus anúncios possuem uma grande variedade de formatos para a campanha, não se limitando apenas aos textos. Isso gera maiores possibilidades de conversão de acordo com o seu público.</p>
                            <p>Além disso o poder de segmentação do Facebook Ads é enorme e você pode detalhar para a ferramenta o perfil do público que você deseja alcançar.</p>
                        </div>
                    </div>
                    <div class="sinlge-middle-content">
                        <h3>Vantagens</h3>
                        <ul class="desc-list">
                            <li> <span class="bold black">Alcançar mais pessoas:</span>   Escolhemos seu público baseado em dados demográficos, comportamentos ou informações de contato.</li>
                            <li> <span class="bold black">Planejamento de Campanha:</span> Confeccionamos as campanhas com as melhores estratégias e as últimas novidades do Facebook para seu negócio.</li>
                            <li> <span class="bold black">Relatórios Semanais:</span>  Nossos relatórios mostram a você como seus anúncios afetaram seu negócio, de forma visual e de fácil leitura.</li>
                            <li> <span class="bold black">Otimização Constante:</span>  Nossa equipe irá fazer otimizações constantes em suas campanhas para aumentar seus resultados.</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="services-right-sidebar">
                    <div class="service-cats-area">
                        ...
                        <form name="formservice">
                            <input type="hidden" ng-init="dados.LE_CodigoProduto='804'">
                ...
                <div class="services-right-sidebar">
                    <div class="service-cats-area">
                        ...
                        <ul id="single-services-cat">
                            ...
                            <li class="active"><a href="facebook-ads">Facebook ADS</a></li>
